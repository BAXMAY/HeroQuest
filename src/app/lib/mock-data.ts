...
export const rewards: Reward[] = [
  {
    ...
    description: 'A cool action figure of your favorite hero.',
    cost: 300,
    image: getImage('reward1'),
  },
  {
    id: 'reward-2',
    name: 'Gummy Bear Snack Pack',
    description: 'A delicious bag of assorted gummy bears.',
    cost: 50,
    image: getImage('reward2'),
  },
  {
    id: 'reward-3',
    name: 'Hero\'s Fruit Juice',
    description: 'A refreshing and healthy fruit juice drink.',
    cost: 75,
  ...
  },
  {
    ...
    description: 'A soft and cuddly friend for your adventures.',
    cost: 200,
  ...
  },
  {
    ...
    description: 'A beautiful doll ready for a royal quest.',
    cost: 250,
  ...
  },
  {
    ...
    description: 'A sweet treat for a well-deserving hero.',
    cost: 100,
