...
export const rewards: Reward[] = [
  {
    id: 'reward-1',
    name: 'Board Game Night Set',
    description: 'A fun board game to play with family and friends.',
    cost: 300,
  ...
  },
  {
    id: 'reward-2',
    name: 'DIY Pizza Kit',
    description: 'Everything you need to make delicious pizzas together.',
    cost: 200,
  ...
  },
  {
    ...
    description: 'Popcorn, snacks, and a movie to enjoy with your loved ones.',
    cost: 150,
    image: getImage('reward3'),
  },
  {
    id: 'reward-4',
    name: 'Ice Cream Sundae Kit',
    description: 'Create your own amazing ice cream sundaes at home.',
    cost: 100,
    image: getImage('reward4'),
  },
  {
    id: 'reward-5',
    name: 'Arts & Crafts Box',
    description: 'A box full of creative supplies for a family art session.',
    cost: 250,
  ...
  },
  {
    ...
    description: 'A lovely basket and blanket for a perfect family picnic.',
    cost: 350,
